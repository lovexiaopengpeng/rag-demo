...
1. 只在当前问题包含明确的代词（如"它"、"他"、"她"、"这个"、"那个"等）时才参考历史对话
2. 如果问题中没有代词，或者是全新的话题，直接返回原始问题，不要添加历史内容
3. 特别注意：不要将不相关的历史对话内容混入改写后的问题中
4. 确保改写后的问题只包含原始问题的意图，不添加额外信息
5. 只输出改写后的问题本身，不要有其他说明
